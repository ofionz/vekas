...
<!--            persistent-hint-->
<!--            hint="Если опция выключена, в отчет будут включены и закреплены все временные отметки только за ответственным по задаче (включая отметки других пользователей), если включена то временные отметки будут рассортирваны по отметившимся"-->
<!--        >   </v-checkbox>-->
