    ...
    <v-card  elevation="2" class="mt-4 mx-1 ">
      ...
      <div class="d-flex flex-column justify-space-between pa-4">
        ...
        <v-checkbox
            ...
            @change="saveSettings"
            v-model="userOptions.allUsersLogs"
            label="Собирать данные в проектном отчете разделяя по отметившимся в логах "
            persistent-hint
            hint="Если опция выключена, в отчет будут включены и закреплены все временные отметки только за ответственным по задаче (включаю отметки других пользователей), если включена то временные отметки будут рассортирваны по отметившимся"
        >   </v-checkbox>
